...
{
    /// <inheritdoc />
    public partial class returningCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RoleServerMember",
                columns: table => new
                {
                    RolesId = table.Column<int>(type: "integer", nullable: false),
                    MembersUserId = table.Column<string>(type: "text", nullable: false),
                    MembersServerId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleServerMember", x => new { x.RolesId, x.MembersUserId, x.MembersServerId });
                    table.ForeignKey(
                        name: "FK_RoleServerMember_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleServerMember_ServerMembers_MembersUserId_MembersServerId",
                        columns: x => new { x.MembersUserId, x.MembersServerId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleServerMember_MembersUserId_MembersServerId",
                table: "RoleServerMember",
                columns: new[] { "MembersUserId", "MembersServerId" });
